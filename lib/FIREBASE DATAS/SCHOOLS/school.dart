...
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';
import 'package:statemanagement/FIREBASE%20DATAS/SCHOOLS/addschool.dart';
...
class _schoolState extends State<school> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("SCHOOLS"),shadowColor: Colors.blue,backgroundColor: Colors.blue,actions: [
        IconButton(onPressed: (){Navigator.of(context).push(MaterialPageRoute(builder: (context){return addschool();}));}, icon: Icon(Icons.add),
        )],),
      body: StreamBuilder(
